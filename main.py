...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","shibam_test_bot")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","pritv9")
...
async def restart(client, m: Message):
        ...
        await accha.edit("⚡ ʜᴇʏ..... ⚡ ɪ'ᴍ ᴋɪʏᴀʀᴀ ᴄʜᴀᴛ ʙᴏᴛ ⚡ ᴀᴅᴅ ᴍᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ғᴏʀ  ᴄʜᴀᴛ ʀᴇᴘʟʏ.⚡ᴏᴡɴᴇʀ - @Anupma_Roy⚡ ᴊᴏɪɴ ᴏᴜʀ ᴄᴏᴍᴍᴜɴɪᴛʏ⚡ @GAsupportcommunity")
